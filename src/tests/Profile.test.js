...
describe('Testa o componente Profile', () => {
  ...
  it('Teste se existe Links na página:', () => {
    renderWithRouter(<Profile />);
  ...
  it('Se redireciona para os caminhos corretos', () => {
  ...
  it('Checa se o email do usuário está sendo exibido na tela', () => {
